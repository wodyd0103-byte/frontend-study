...
피그마 시안(호텔예약 데스크톱/모바일) 기반 산출물 프로젝트입니다. `HOTELPROJECT/src` 아래 html / css / js / images. 현재 HOME.html(스와이퍼 히어로 + 웹 컴포넌트 푸터)까지 작성, rooms · reservation 페이지는 뼈대만 생성. db.json의 rooms · season · holiday · price · reservation 컬렉션과 fetch로 연동 예정.
